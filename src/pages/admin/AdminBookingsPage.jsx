                                ...
                                <div className=" text-gray-800 shadow-lg bg-gray-100 rounded-lg p-4 flex flex-col md:flex-row gap-4 md:gap-8">
                                    ...
                                    <div className="w-full md:w-2/3 space-y-6">
                                        ...
                                        <div className="mt-4 space-y-2">
                                            ...
                                            {
                                                !isAuthenticated ? (
                                                    <div className={` z-10 p-5 flex justify-center items-center relative overflow-hidden`}>
                                                                        ...
                                                                        shows.map((show, index) => {
                                                                            if (show?.status === STATUS_ACTIVE) {
                                                                                return (
                                                                                    <button
                                                                                        key={index}
                                                                                        className={`${selectedShow._id === show._id ? 'text-gray-800 border border-green-800/70 hover:bg-green-800/20 focus:ring-green-800/70 bg-green-800/40' : 'text-gray-800 border border-skin-base hover:bg-skin-base/20 focus:ring-skin-muted'} focus:ring-1 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 inline-flex items-center gap-2`}
