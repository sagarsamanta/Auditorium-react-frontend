...
import { getAdminBookings, getAdminUsersBookings } from "../../../lib/utils";
...
const UsersBookings = () => {
  ...
  useEffect(() => {
    const response = async () => {
      const data = await getAdminUsersBookings(user?._id, token);
    ...
    <>
      <main className="my-bookings-page">
        <div className="flex justify-between items-center p-4 border border-slate-100 rounded-md shadow-md">
          <h1 className="text-xl md:text-2xl lg:text:3xl">Users Bookings</h1>
        </div>
