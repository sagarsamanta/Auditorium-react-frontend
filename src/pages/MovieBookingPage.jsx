                ...
                <div className="mx-auto container px-2 sm:px-6 lg:px-8 py-4 space-y-4">
                    {loading.movie ? (
                        ...
                        <div className="absolute top-1/3 left-1/2 -translate-y-1/2 -translate-x-1/2 z-10">
                            ...
                            />
                            <button
                                className="text-sm p-2 md:px-4 rounded-full transition bg-gray-800/20 hover:bg-gray-800/50 text-skin-inverted flex items-center gap-2 mx-auto mt-4"
                                title="Back"
                                onClick={() => navigate(-1)}
                            >
                        ...
                        <>
                            <button
                                className="text-sm p-2 md:px-4 rounded-full transition bg-gray-800/20 hover:bg-gray-800/50 text-skin-inverted flex items-center gap-2"
                                title="Back"
                                onClick={() => navigate(-1)}
                            >
                                <IoArrowBack size={20} />
                            ...
                            <div className="bg-gray-800 text-skin-inverted rounded-lg p-4 flex flex-col md:flex-row gap-4 md:gap-8">
                                ...
                                <div className="w-full md:w-2/3 space-y-6">
                                    ...
                                    <div className="mt-4 space-y-2">
                                        {!isAuthenticated ? (
                                            <div
                                                className={`bg-gray-800 z-10 p-5 flex justify-center items-center relative overflow-hidden`}
                                            >
                                                            ...
                                                            {shows.map((show, index) => {
                                                                if (show?.status === STATUS_ACTIVE) {
                                                                    return (
                                                                        <button
                                                                            key={index}
                                                                            className={`${selectedShow._id === show._id
                                                                                ? "text-skin-inverted border border-green-800/70 hover:bg-green-800/20 focus:ring-green-800/70 bg-green-800/40"
                                                                                : "text-skin-inverted border border-skin-base hover:bg-skin-base/20 focus:ring-skin-muted"
