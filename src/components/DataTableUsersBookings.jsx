...
const DataTableUsersBookings = ({ data, className }) => {    
    const columns = [
        ...
        //     selector: row => (
        //         < className="space-x-4">
        //             <Link to={`/admin/users/bookings/movie/${row._id}`} className="text-xs inline-block py-2 px-4 rounded-lg transition duration-200 border border-blue-600 w-24 text-center text-blue-600 font-serif hover:bg-blue-600 hover:text-white">View</Link>
